...
class BandsMusiciansRepositoryWithExtensionTest {

    BandsMusiciansRepository repository;

    public BandsMusiciansRepositoryWithExtensionTest(EntityManagerFactory factory) {
        this.repository = new BandsMusiciansRepository(factory);
    }
