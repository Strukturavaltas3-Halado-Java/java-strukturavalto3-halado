...
public class BookController {
    ...
    @PutMapping("/{id}")
    public BookWithGenreDto updateBookWithGenre(@PathVariable("id") long id, @Valid @RequestBody UpdateBookWithGenreCommand command) {
        return bookService.updateBookWithGenre(id, command);
    }
}
